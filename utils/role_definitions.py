...
ROLE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    # Creative roles
    "content_creator": {"name": "Content Creator", "emoji": "🎤", "category": RoleCategory.CREATIVE, "description": "Twitch, YouTube, podcast, etc."},
    "artist": {"name": "Artist", "emoji": "🎨", "category": RoleCategory.CREATIVE, "description": "GFX design, digital art, traditional art, etc."},
    "developer": {"name": "Developer", "emoji": "👨‍💻", "category": RoleCategory.CREATIVE, "description": "Video game, mobile, web, etc."},
    "photographer": {"name": "Photographer", "emoji": "📸", "category": RoleCategory.CREATIVE, "description": "IRL and virtual"},
    "tech_expert": {"name": "Tech Expert", "emoji": "👨‍🔧", "category": RoleCategory.CREATIVE, "description": "Hardware, software, troubleshooting"},
